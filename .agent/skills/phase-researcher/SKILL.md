...
| `## Antigravity's Discretion` | Your freedom areas — research options, recommend |
...
## Antigravity's Training as Hypothesis

Antigravity's training data is 6-18 months stale. Treat pre-existing knowledge as hypothesis, not fact.

**The trap:** Antigravity "knows" things confidently. But that knowledge may be:
- Outdated (library has new major version)
- Incomplete (feature was added after training)
- Wrong (Antigravity misremembered or hallucinated)
...
| **Antigravity's Discretion** | Your freedom areas — research options, make recommendations |
| **Deferred Ideas** | Out of scope — ignore completely |
