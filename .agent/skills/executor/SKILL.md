...
**See .agent/resources/references/checkpoints.md**

**Quick reference:**
- Users NEVER run CLI commands - Antigravity does all automation
- Users ONLY visit URLs, click UI, evaluate visuals, provide secrets
- Antigravity starts servers, seeds databases, configures env vars
...
- Clear history for Antigravity in future sessions
  </task_commit_protocol>
...
**Use template from:** .agent/resources/templates/summary.md
