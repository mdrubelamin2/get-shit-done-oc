...
.agent/resources/workflows/execute-phase.md
</execution_context>
...
See `.agent/resources/workflows/execute-phase.md` step `checkpoint_handling` for complete details.
</checkpoint_handling>
