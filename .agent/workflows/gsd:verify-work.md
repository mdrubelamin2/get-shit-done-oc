...
Purpose: Confirm what Antigravity built actually works from user's perspective. One test at a time, plain text responses, no interrogation. When issues are found, automatically diagnose, plan fixes, and prepare for execution.
...
<execution_context>
.agent/resources/workflows/verify-work.md
.agent/resources/templates/UAT.md
</execution_context>
