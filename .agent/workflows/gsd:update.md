...
// turbo
```bash
cat .agent/resources/VERSION 2>/dev/null
```
...
- `.agent/resources/commands/gsd/` will be wiped and replaced
- `.agent/resources/` will be wiped and replaced
- `.agent/resources/agents/gsd-*` files will be replaced

Your custom files in other locations are preserved:
- Custom commands in `.agent/resources/commands/your-stuff/` ✓
...
```bash
rm -f .agent/resources/cache/gsd-update-check.json
```
</step>
...
⚠️  Restart Antigravity to pick up the new commands.
