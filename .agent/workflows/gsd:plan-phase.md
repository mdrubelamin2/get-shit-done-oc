...
**Task Context:**
First, read .agent/skills/phase-researcher/SKILL.md for your role and instructions.\n\n" + research_prompt,
  subagent_type=
...
**How to proceed:**
1. Read the plan-checker skill:
   ```
   View file: .agent/skills/plan-checker/SKILL.md
   ```
2. Follow the skill's instructions, applying them to the task context above. Note: You are Antigravity, follow the instructions as Antigravity.
3. Create outputs as specified in the skill
...
**Task Context:**
First, read .agent/skills/planner/SKILL.md for your role and instructions.\n\n
