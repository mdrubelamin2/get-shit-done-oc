...
**commands/gsd/**
- Purpose: Slash command definitions for Antigravity
...
- `GEMINI.md` - Instructions for Antigravity when working in this repo
...
- UPPERCASE.md: Important project files (README, ANTIGRAVITY, CHANGELOG)
...
- Usage: Reference from command with `.agent/resources/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to .agent/resources/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to .agent/resources/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
