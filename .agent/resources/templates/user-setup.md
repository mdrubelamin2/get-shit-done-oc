...
Template for `.planning/phases/XX-name/{phase}-USER-SETUP.md` - human-required configuration that Antigravity cannot automate.

**Purpose:** Document setup tasks that literally require human action - account creation, dashboard configuration, secret retrieval. Antigravity automates everything possible; this file captures only what remains.
...
Complete these items for the integration to function. Antigravity automated everything possible; these items require human access to external dashboards/accounts.
...
**USER-SETUP.md contains ONLY what Antigravity literally cannot do.**

| Antigravity CAN Do (not in USER-SETUP) | Antigravity CANNOT Do (→ USER-SETUP) |
|-----------------------------------|--------------------------------|
...
**The test:** "Does this require a human in a browser, accessing an account Antigravity doesn't have credentials for?"
- Yes → USER-SETUP.md
- No → Antigravity does it automatically
...
**Never include:** Actual secret values. Steps Antigravity can automate (package installs, code changes).
