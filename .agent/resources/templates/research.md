...
**Purpose:** Document what Antigravity needs to know to implement a phase well - not just "which library" but "how do experts build this."
...
- When Antigravity's training data is likely stale or sparse
