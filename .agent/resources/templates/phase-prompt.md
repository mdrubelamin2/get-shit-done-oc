...
user_setup: []              # Human-required setup Antigravity cannot automate (see below)
...
.agent/resources/references/checkpoints.md
</execution_context>
...
<!-- For checkpoint task examples and patterns, see .agent/resources/references/checkpoints.md -->
...
<task type="checkpoint:human-verify" gate="blocking">
  <what-built>[What Antigravity built] - server running at [URL]</what-built>
...
See `.agent/resources/references/tdd.md` for TDD plan structure.
...
<!-- Checkpoint pattern: Antigravity starts server, user visits URL. See checkpoints.md for full patterns. -->
<task type="auto">
...
- Always use XML structure for Antigravity parsing
...
**The automation-first rule:** `user_setup` contains ONLY what Antigravity literally cannot do:
- Account creation (requires human signup)
- Secret retrieval (requires dashboard access)
- Dashboard configuration (requires human in browser)

**NOT included:** Package installs, code changes, file creation, CLI commands Antigravity can run.

**Result:** Execute-plan generates `{phase}-USER-SETUP.md` with checklist for the user.

See `.agent/resources/templates/user-setup.md` for full schema and examples
...
See `.agent/resources/workflows/verify-phase.md` for verification logic.
