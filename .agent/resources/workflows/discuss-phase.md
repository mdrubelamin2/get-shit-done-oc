...
2. **gsd-planner** — Reads CONTEXT.md to know WHAT decisions are locked
   ...
   - "Antigravity's Discretion: loading skeleton" → planner can decide approach
...
<philosophy>
**User = founder/visionary. Antigravity = builder.**
...
**Antigravity handles these (don't ask):**
...
2. **Ask 4 questions using AskUserQuestion:**
   ...
   - Include "You decide" as an option when reasonable — captures Antigravity discretion
...
[Areas where user said "you decide" — note that Antigravity has flexibility here]
