...
Antigravity's training data is 6-18 months stale. Always verify.

1. **Context7 MCP FIRST** - Current docs, no hallucination
2. **Official docs** - When Context7 lacks coverage
3. **WebSearch LAST** - For comparisons and trends only

See .agent/resources/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using .agent/resources/templates/discovery.md structure:
...
1. **Scope the discovery** using .agent/resources/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from .agent/resources/templates/discovery.md
...
Use .agent/resources/templates/discovery.md.
