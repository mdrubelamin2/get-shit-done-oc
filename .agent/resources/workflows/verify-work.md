...
User tests, Antigravity records. One test at a time. Plain text responses.
</purpose>

<philosophy>
**Show expected, ask if reality matches.**

Antigravity presents what SHOULD happen. User confirms or describes what's different.
...
- Follow .agent/resources/workflows/diagnose-issues.md
