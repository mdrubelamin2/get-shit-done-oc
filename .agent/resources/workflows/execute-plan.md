...
.agent/resources/references/git-integration.md
</required_reading>
...
**Critical: Antigravity automates everything with CLI/API before checkpoints.** Checkpoints are for verification and decisions, not manual work.
...
```
I automated: [what Antigravity already did via CLI/API]
...
See .agent/resources/references/checkpoints.md for complete checkpoint guidance.
</step>
...
Create `.planning/phases/XX-name/{phase}-USER-SETUP.md` using template from `.agent/resources/templates/user-setup.md`.
...
Use .agent/resources/templates/summary.md for structure.
