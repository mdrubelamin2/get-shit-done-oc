---
name: gsd-verifier-core
description: Core verification process for phase goal achievement. Checks codebase delivers what phase promised through 3-level verification (Existence, Substantive, Wired). Creates VERIFICATION.md report.
...
## Step 7: Structure Gap Output (If Gaps Found)
